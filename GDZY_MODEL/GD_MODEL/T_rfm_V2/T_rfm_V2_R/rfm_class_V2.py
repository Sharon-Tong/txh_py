...
from GDZY_MODEL.GD_MODEL.T_rfm_V2.T_rfm_V2_R.rtl_rfm_class_base import RtlRfmMedianClass
from GDZY_MODEL.GD_MODEL.T_rfm_V2.T_rfm_V2_R.BASE.BaseData import dataGatherBase
...
if __name__ == "__main__":
    logger.get_logger().info('开始计算零售的分类...')
    start_time = time.time()
    bb= RFMRtlKhGDZY()
    bb.GdzyRfm()
    end_time = time.time()
    m,s = divmod(end_time-start_time,60)
    logger.get_logger().info('运行结束...\n运行时间为：%3d分%2d秒' %(m,s))