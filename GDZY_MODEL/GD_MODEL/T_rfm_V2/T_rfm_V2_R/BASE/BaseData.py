...
class dataGatherBase():
    ...
    def sel_rtl_M_data(self, week_vec,city_code ,bar_codes):
        ...
        s_sql1 = "select week_id, provc_code, city_code, bar_code, cust_code, order_amt, order_qty from gdzy_dm_yx.dd_order_w where  order_qty>0 " \
                 " and city_code='11110001' and p_week_id='201935' limit 10"
