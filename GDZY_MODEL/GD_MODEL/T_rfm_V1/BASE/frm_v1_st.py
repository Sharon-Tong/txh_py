...
class RFMRtlKhGDZY():
    ...
    def GdzyRfm(self):
        self.logger.info("处理的核心户情况中烟为："+ str(RfmParam.corp_name) + "；处理的时间为：" + str(self.Param.busidate)+"；处理的地市为："+str(self.Param.city_name_1))
        ...
        all_data = dataGatherBase().sel_rtl_M_data(self.Param.date_start, self.Param.date_end, self.Param.city_code_1)
